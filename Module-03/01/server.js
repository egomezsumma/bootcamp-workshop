...
app.get('/', function (req, res) {
  docs.find(req.query.search, function (err, docs) {
...
app.get('/new', function (req, res) {
  docs.createNew(function (err, id) {
    if (err) return res.send(500, err);
    res.redirect('/doc/' + id);
  });
});
...
app.get('/doc/:id', function (req, res) {
  docs.getById(req.params.id, function (err, doc) {
...
app.patch('/doc/:id', function (req, res) {
  docs.save(req.params.id, req.body, function (err, count) {
    if (err) return res.send(500);
